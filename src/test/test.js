...
assert( checkPlayerPillarCollision( 500, 200, 200, 200 ), false,
  'when the dot is very far right of the pillar pair' );
assert( checkPlayerPillarCollision( 300, 300, 300, 200 ), true,
	'when the dot hit the middle of the top pillar' );
assert( checkPlayerPillarCollision( 265, 300, 300, 200 ), true,
  	'when the dot hit the left of the top pillar' );
assert( checkPlayerPillarCollision( 265, 100, 300, 200 ), true);
